const switchTheme = (function () {
  ...
  const themes = [
    function darkTheme() {
      ...
      const background = document.getElementById('background3');
      background.style.setProperty('background-color', '#000000');
    ...
    function lightTheme() {
      const root = document.documentElement;
      const background = document.getElementById('background3');
      background.style.setProperty('background-color', '#FFFFFF');
